...
imagery_composite = os.path.join(composite_folder, 'GMT2_MaxarComposite_WGS84.tif')
imagery_segmentation = os.path.join(composite_folder, 'GMT2_MaxarComposite_AKALB.tif')
