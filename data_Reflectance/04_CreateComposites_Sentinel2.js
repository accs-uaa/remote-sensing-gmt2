/* -*- coding: utf-8 -*-
---------------------------------------------------------------------------
Cloud-reduced Seasonal Median Composites of Sentinel 2 Imagery circa 2019-2022
Author: Timm Nawrocki, Alaska Center for Conservation Science
Last Updated: 2022-11-21
Usage: Must be executed from the Google Earth Engine code editor.
Description: This script produces a set of cloud-reduced median composite for bands 1-12 plus Enhanced Vegetation Index-2 (EVI2), Normalized Burn Ratio (NBR), Normalized Difference Moisture Index (NDMI), Normalized Difference Snow Index (NDSI), Normalized Difference Vegetation Index (NDVI), Normalized Difference Water Index (NDWI) using the Sentinel-2 Surface Reflectance image collections. Composites are centered around June 10, July 30, August 20, and September 15.
---------------------------------------------------------------------------*/
...
var filter_june = ee.Filter.or(
  ...
  ee.Filter.date('2022-05-20', '2022-06-30'));
...
var filter_august = ee.Filter.or(
  ...
  ee.Filter.date('2022-07-15', '2022-09-25'));
...
var filter_september = ee.Filter.or(
  ...
  ee.Filter.date('2022-08-20', '2021-10-10'));
